...
<pre>
      ...
      =-#+#*=**+**#@%** .@@@@*       based  : Delft, Netherlands
       -+%##+#%+#=#@@+*%@@@@#        now    : Montana Aerospace — intern (Aug 2026)
        *%@%%==+###**: -  :*         next   : AeroDelft — electronics (Sep 2026)
          .:*-...   .. -. :+         edu    : BSc AE, TU Delft · IB 42/45
             .--..   =-=@:**         focus  : controls · sensor fusion · signal processing
             :*=--   ::=##%          stack  : Python · C++ · SQL · NumPy · FastAPI · Postgres
               -=:-:-==-*#@          web    : <a href="https://andrejbosnjak.com">andrejbosnjak.com</a>
               :.++=-: ..+           git    : <a href="https://github.com/andrejbosnjakk">github.com/andrejbosnjakk</a>
               -  :+***#%@@@         in     : <a href="https://www.linkedin.com/in/andrej-bosnjak-533a6b310/">in/andrej-bosnjak</a>
            *-.-    .:+*%@@@@+:=-*
        #=-:   :......:+%@@%+- :.=
      =-:.      .:==-=***-:.=#. .+
      :.         .-  =*  .::*#*==#
